...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-20 pb-24 px-4 overflow-hidden bg-slate-50">
      ...
      >
        {/* --- Top Badge --- */}
        <motion.div variants={itemVariants} className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-50 border border-indigo-100 text-indigo-700 font-bold text-xs sm:text-sm mb-8 shadow-sm">
        ...
        >
          ...
          <span className="relative inline-block mt-2">
            <span className="relative z-10 text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-blue-500 to-purple-600">
              Future.
            </span>
            <motion.div 
              initial={{ width: 0 }}
        ...
        >
          ...
          <span className="text-slate-900 font-bold"> real-time proctoring</span> and 
          <span className="text-slate-900 font-bold"> instant global insights</span> in one unified platform.
        </motion.p>
