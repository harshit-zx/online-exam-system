              ...
              {exams.map((exam) => (
                ...
                >
                  <ExamCard
                    ...
                    buttonText={user ? "Start Exam" : "Login to Take Exam"}
                  />
                </div>
              ))}
            </div>
                ...
                leaderboard.map((u, i) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <span
                        className={`w-8 h-8 rounded-full flex items-center justify-center font-black text-sm ${i === 0 ? "bg-amber-400 text-amber-900" : i === 1 ? "bg-slate-300 text-slate-800" : i === 2 ? "bg-amber-700/80 text-white" : "bg-slate-700 text-slate-300"}`}
                      >
                        {i + 1}
                      </span>
                      <div>
