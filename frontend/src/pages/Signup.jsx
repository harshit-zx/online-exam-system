        ...
        <div className="hidden md:flex bg-slate-900 text-white items-center justify-center p-16 relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-md">
            ...
            <h2 className="text-5xl font-bold mb-6 leading-[1.1]">
              Shape your <span className="text-indigo-400">Future</span> with
              us.
            </h2>

            <p className="text-slate-300 text-lg leading-relaxed mb-10">
              Join a community of educators and learners using the most secure
              exam environment.
            </p>
            ...
            <div className="space-y-4">
              {[
                {
                  title: "Secure Exams",
                  desc: "Anti-cheating browser lock",
                  icon: <ShieldCheck size={20} />,
                },
                {
                  title: "Instant Result",
                  desc: "Get feedback in real-time",
        ...
        <div className="p-10 md:p-20 flex flex-col justify-center">
          <div className="mb-8">
            ...
            <p className="text-slate-500 mt-2">
              Join to begin your examination journey.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full bg-slate-50 border border-slate-200 pl-11 pr-4 py-3.5 rounded-2xl focus:border-indigo-500 outline-none transition-all"
                />
              </div>
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="w-full bg-slate-50 border border-slate-200 pl-11 pr-12 py-3.5 rounded-2xl focus:border-indigo-500 outline-none transition-all"
                />
                <button
                  type="button"
            ...
            <button
              disabled={loading}
              className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-4 rounded-2xl transition-all shadow-lg disabled:opacity-70 flex items-center justify-center gap-3"
            >
              {loading ? (
